...
public class DeckChildView<T> extends FrameLayout implements
    ...
    public void onDataLoaded(T key, Bitmap thumbnail, Drawable headerIcon,
                             String headerTitle, int headerBgColor,String titleContext,String subTitleitleContext,String url) {
        ...
        if (mThumbnailView != null && mHeaderView != null) {
            ...
            mHeaderView.rebindToTask(headerIcon, headerTitle, headerBgColor,titleContext,subTitleitleContext,url);
